...
if __name__ == "__main__":
    ...
    pic_enc(x1, y_ticks, y_visual, case1, case211, case221, FSMSA_Server, VeSAFL, 1.5, 10.5, "Model Dimension (x10\u2074)", "Data for verification (MB)",
    ...
    y_ticks = [0, 1, 10, 100, 1000, 10000, 100000]
    y_visual = [0, 1, 10, r'$10^2$', r'$10^3$', r'$10^4$', r'$10^5$']
    pic_enc(x1, y_ticks, y_visual, case1, case211, case221, FSMSA_Server, VeSAFL, 15, 105, "Client Number", "Data for verification (MB)",
